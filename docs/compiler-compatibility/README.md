...
| 0.67.1 | `Flix0661Adapter` | yes | yes | yes | yes | not rerun | [investigation](flix-0.67.1.md) |
...
artifacts: 0.66.0 must fail compiler-runtime inspection, while 0.66.1, 0.67.1, 0.67.2, 0.68.0,
0.75.2, and 0.75.3 must pass packaged integration. Intermediate releases may satisfy the structural gate, but remain unverified
