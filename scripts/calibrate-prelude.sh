...
exec java -cp "$root/out/plugin/compile.dest/classes:$root/out/adapter/flix0761/compile.dest/classes:$root/out/plugin/test/compile.dest/classes:$root/plugin/lib/flix.jar" \
