...
exec java -cp "$root/out/plugin/compile.dest/classes:$root/out/adapter/flix0753/compile.dest/classes:$root/out/plugin/test/compile.dest/classes:$root/plugin/lib/flix.jar" \
