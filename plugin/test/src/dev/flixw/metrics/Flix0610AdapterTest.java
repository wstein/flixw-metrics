...
import dev.flixw.metrics.adapter.Flix0610Adapter;
...
public final class Flix0610AdapterTest {
    private Flix0610AdapterTest() { }

    public static void main(String[] args) throws Exception {
        Path project = Flix0753AdapterTest.copyFixture(Path.of(args[0]));
        try {
            Model model = new Flix0610Adapter().measure(project);
            ...
            Flix0753AdapterTest.assertRestrictableEnums(
                new Flix0610Adapter().measure(project));
            ...
            Flix0753AdapterTest.assertEffectMetrics(new Flix0610Adapter().measure(project));
            Flix0753AdapterTest.writeHandlerFixture(project);
            Flix0753AdapterTest.assertHandlerMetrics(new Flix0610Adapter().measure(project));
            System.out.println("Flix0610AdapterTest: ok");
        } finally {
