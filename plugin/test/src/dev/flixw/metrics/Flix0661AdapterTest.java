...
import dev.flixw.metrics.adapter.Flix0661Adapter;
...
public final class Flix0661AdapterTest {
    private Flix0661AdapterTest() { }

    public static void main(String[] args) throws Exception {
        Path project = Flix0753AdapterTest.copyFixture(Path.of(args[0]));
        try {
            Model model = new Flix0661Adapter().measure(project);
            ...
            Flix0753AdapterTest.assertRestrictableEnums(
                new Flix0661Adapter().measure(project));
            ...
            Flix0753AdapterTest.assertEffectMetrics(new Flix0661Adapter().measure(project));
