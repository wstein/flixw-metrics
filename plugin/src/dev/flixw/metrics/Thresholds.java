...
final class Thresholds {
    ...
    /** Browser-visible width of the formal-parameter span generated by FlixDoc. */
    static final int MAX_FLIXDOC_PARAMETER_CHARACTERS =
        (int) RuleDefinitions.NOISY_FLIXDOC_PARAMETERS.defaultLimit();
