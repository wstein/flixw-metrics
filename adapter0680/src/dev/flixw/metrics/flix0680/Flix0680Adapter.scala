package dev.flixw.metrics.flix0680
 ...
 *
 * `Flix0680` names the oldest verified release in this linkage family, not its newest supported release.
 ...
 */
final class Flix0680Adapter extends CompilerModel {
  ...
  private def toSpan(loc: SourceLocation): Span =
    Span(loc.source, loc.startLine, loc.startCol, loc.endLine, loc.endCol)
